/*
ex7: char drv module is with locking mechanisam of semaphore
...
static int char_drv_module_init(void)
{
	...
	printk("char drv module loaded suceessfully..major no=%d minor no=%d\n",major_num,minor_num);
	return 0;
...
MODULE_AUTHOR("Alex");
MODULE_DESCRIPTION("char drv module with semaphore lock in read and write ops");
MODULE_LICENSE("GPL");
