...
Method: used device number as: static major and minor number
*/
...
int major=255,minor=0; //static major number, pls fill here
dev_t char_dev;
...
static int char_drv_module_init(void)
{
	...
	printk("char drv module loaded successfully\n");
	return 0;
